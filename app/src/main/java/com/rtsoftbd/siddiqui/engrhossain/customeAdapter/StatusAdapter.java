...
package com.rtsoftbd.siddiqui.engrhossain.customeAdapter;
...
public class StatusAdapter extends BaseAdapter {
    ...
    public StatusAdapter(List<Status> statusList, Activity activity) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.ms_Date.setText(status.get_date());
